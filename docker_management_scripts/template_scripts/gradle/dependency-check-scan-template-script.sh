...
DC_PROJECT_ROOT_TO_SCAN_DIRECTORY="/opt/DependencyCheck/dependency-check-projects-to-scan/vulnerable-java-application/build"  # Root directory of the project to scan with DependencyCheck
DC_PROJECT_NAME="vulnerable-java-application"                                                                		      # The name of the project being scanned
 	  ...
 	  echo -e "\e[33mFound Maven project files in the '$DC_PROJECT_NAME' project.\e[0m"
    	  ...
    	  if [ -f "pom.xml" ] && grep -q "<project" pom.xml; then
            ...
            if [ -d "target" ]; then
              ...
              echo -e "\e[33mProceeding to scan '$DC_PROJECT_NAME' project with DependencyCheck Maven plugin...\e[0m"
...
echo -e "\e[32mExecutionicompleted successfully!\e[0m"